...
def validate_new_chat_start_contract(root: str|Path):
    ...
    if not errors:
        ...
        for phrase in ['Verify the authority ZIP SHA-256','/mnt/data/Metablooms_OS','boot_critical_governance_loader_v1.py','governance_scatter_prevention_v1.py','fresh_chat_boot_rehearsal_v1.py','prompt_governance_v1']:
