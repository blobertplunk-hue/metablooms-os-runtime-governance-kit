...
def save_json(path: Path, obj: Any) -> None:
    _mb_write_json_file(path, obj, operation_id="STAGE4_REGISTRY_MUTATION_SAVE_JSON", create_parent=True, allowed_roots=[str(ROOT.resolve())], indent=2, sort_keys=False, ensure_ascii=False, max_bytes=20000000)
