...
def main(argv=None)->int:
    ...
    _mb_write_json_file(Path(args.report), report, operation_id='STAGE4_ATOMIC_JSON_0_kernel_cartridges_inline_project_tracker_TRACKER_STALE_STATE_VALIDAT_L50', create_parent=True, allowed_roots=[str(_MBAJWPath('/mnt/data').resolve())], indent=2, sort_keys=True, ensure_ascii=True, max_bytes=20000000)
